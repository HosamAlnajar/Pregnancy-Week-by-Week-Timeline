...
use Post_Timeline\Admin\Timeline_Admin_Menu;
...
class Post_timeline {
	...
	public function __construct() {
		if ( defined( 'POST_TIMELINE_VERSION' ) ) {
			$this->version = POST_TIMELINE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'post_timeline';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-post_timeline-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-post_timeline-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-post_timeline-admin.php';


		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-post-timeline-admin-menu.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-post_timeline-public.php';
